...
type User struct {
	...
	Apellidos       string             `bson:"last_name" json:"last_name,omitempty" valid:"optional" `
	FechaNacimiento time.Time          `bson:"nacimiento" json:"nacimiento,omitempty" valid:"required"`
